 ...
 * 
 */
@WebServiceClient(name = "WebServiceService", targetNamespace = "http://service.system_c.example.com/", wsdlLocation = "http://localhost:8101/Service/getAWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://service.system_c.example.com/", "WebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8101/Service/getAWebService?wsdl");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://service.system_c.example.com/", "WebServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.system_c.example.com/", "WebServicePort"), WebService.class, features);
    }
