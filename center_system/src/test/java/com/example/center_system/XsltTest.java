...
//                "</课程列表C></C院系共享课程信息>";
        String xml = "<A系统全部课程信息><课程列表A>" +
                "<课程信息A><课程编号A>cno</课程编号A><课程名A>cname</课程名A>" +
                "<授课教师A>teacher</授课教师A><课程学分A>credit</课程学分A><选课人数A>100</选课人数A>" +
                "</课程信息A><课程信息A><课程编号A>1</课程编号A><课程名A>syf</课程名A><授课教师A>t</授课教师A>" +
                "<课程学分A>4</课程学分A><选课人数A>50</选课人数A></课程信息A>" +
                "</课程列表A></A系统全部课程信息>";
        ...
        System.out.println(xmlTransfer(xml, xsltUri1).substring(38));
    }
